...
## CRUD UPDATE
# UrbanVeggieBurger = session.query(MenuItem).filter_by(id=5).one()
# UrbanVeggieBurger.price = '$2.99'
# session.add(UrbanVeggieBurger)
# session.commit()
#
# veggieBurgers = session.query(MenuItem).filter_by(name='Veggie Burger')
# print 'id\t\t\tPrice\t\t\tRestaurant Name'
# for veggieBurger in veggieBurgers:
#     print '%s\t\t\t%s\t\t\t%s' %(veggieBurger.id, veggieBurger.price, veggieBurger.restaurant.name)
